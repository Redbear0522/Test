...
<head>
    ...
    <style>
        body { margin:0; padding:0; font-family: 'Noto Sans KR', sans-serif; background:#f8f8f8;}
        .admin-wrapper { max-width:1400px; margin:40px auto 0 auto; padding:0 20px; }
...
<div class="admin-wrapper">
    ...
    <div class="dashboard-cards">
        ...
        <div class="dashboard-card">
            ...
            <a class="card-link" href="<%=request.getContextPath()%>/product/allBidding.jsp">입찰 내역</a>
        </div>
        <div class="dashboard-card">
                ...
                <% for (ChargeRequestDTO req : chargeList) {
                    ...
                    <div class="charge-card">
                        ...
                        <div class="charge-actions">
                            <a class="charge-btn approve-btn" href="<%= request.getContextPath() %>/admin/chargeAction?reqId=<%= req.getReqId() %>&action=approve">승인</a>
                            <a class="charge-btn reject-btn" href="<%= request.getContextPath() %>/admin/chargeAction?reqId=<%= req.getReqId() %>&action=reject">거부</a>
                        </div>
                    </div>
                <% }} %>
            </div>
