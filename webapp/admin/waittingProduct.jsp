...
<%@ page import="com.auction.dao.ProductDAO, com.auction.vo.ProductDTO, com.auction.dao.AdminDAO"%>
...
<%
    ...
    try (Connection conn = getConnection()) {
        ...
        // 페이징 적용된 상품 리스트 조회
        productList = new AdminDAO().selectPendingProductsList(conn);
    } catch (Exception e) {
        e.printStackTrace();
    }
%>
...
<% if (productList != null && !productList.isEmpty()) {
     ...
     <div class="product-card">
         ...
         <p class="price">₩ <%= new java.text.DecimalFormat("###,###").format(p.getStartPrice()) %></p>
         <a href="productDetail.jsp?productId=<%=p.getProductId()%>" class="details-btn">상세 보기</a>
     </div>
<%   }
   } else { %>
    <p>등록된 상품이 없습니다.</p>
